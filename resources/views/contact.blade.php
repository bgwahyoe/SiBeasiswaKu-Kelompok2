          ...
          <section class="bg-[var(--background-primary)] p-6 sm:p-8 rounded-xl shadow-lg">
            ...
            <form class="space-y-6" id="contact-form">
              ...
              <div>
                ...
                <input class="form-input" id="email" placeholder="you@example.com" type="email" required/>
              </div>
              <div>
                <label class="form-label" for="subject">Subject</label>
                <input class="form-input" id="subject" placeholder="Inquiry about..." type="text" required/>
              </div>
              <div>
                <label class="form-label" for="message">Message</label>
                <textarea class="form-input min-h-32" id="message" placeholder="Write your message here..." required></textarea>
              </div>
          ...
          <section class="space-y-8">
            <div class="bg-[var(--background-primary)] p-6 sm:p-8 rounded-xl shadow-lg">
              ...
              <dl class="grid grid-cols-[auto_1fr] gap-x-4">
                <dt class="flex items-center text-[var(--primary-color)] py-3">
                  <svg class="size-5 mr-3" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="contact-info-label font-medium">Email</span>
                </dt>
                <dd class="py-3 border-b border-[var(--secondary-color)]">
                  <a class="contact-info-value hover:text-[var(--primary-color)] transition-colors" href="mailto:support@sibeasiswaku.com">support@sibeasiswaku.com</a>
                </dd>
                <dt class="flex items-center text-[var(--primary-color)] py-3">
                  <svg class="size-5 mr-3" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="contact-info-label font-medium">Phone</span>
                </dt>
                <dd class="py-3 border-b border-[var(--secondary-color)]">
                  <a class="contact-info-value hover:text-[var(--primary-color)] transition-colors" href="tel:+62895604849987">+62 895-6048-49987</a>
                </dd>
                <dt class="flex items-center text-[var(--primary-color)] py-3">
                  <svg class="size-5 mr-3" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="contact-info-label font-medium">Address</span>
                </dt>
                <dd class="py-3">
            ...
            <div class="bg-[var(--background-primary)] p-1 rounded-xl shadow-lg">
              <div class="w-full aspect-[16/10] rounded-lg overflow-hidden">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.344265492451!2d106.83017287474471!3d-6.34968999364134!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec6720e03c45%3A0x140685645706795!2sJl.%20Lenteng%20Agung%20Raya%20No.20%2C%20RT.4%2FRW.1%2C%20Lenteng%20Agung%2C%20Kec.%20Jagakarsa%2C%20Kota%20Jakarta%20Selatan%2C%20Daerah%20Khusus%20Ibukota%20Jakarta%2012640!5e0!3m2!1sen!2sid!4v1719662301121!5m2!1sen!2sid" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
          </section>
        </div>
